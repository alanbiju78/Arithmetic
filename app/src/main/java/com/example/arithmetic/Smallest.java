        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    ...
                    if(numb1<numb2) {
                        Toast.makeText(getApplicationContext(),num1+" is smaller",Toast.LENGTH_LONG).show();
                    }
                    else if(numb2<numb1){
                        Toast.makeText(getApplicationContext(),num2+" is smaller",Toast.LENGTH_LONG).show();
                    }
                    else{
